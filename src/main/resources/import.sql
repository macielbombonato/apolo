...
INSERT INTO users_in_groups (user_id, group_id) VALUES ((SELECT user_id FROM users WHERE email = 'admin@apolo.br'), (SELECT user_group_id FROM user_group WHERE name = 'Administrators'));
...
INSERT INTO users (name, email, password, status, created_by, creation_dt) VALUES ('Power user', 'user@apolo.br', '21232f297a57a5a743894a0e4a801fc3', 'active', 1, NOW());
INSERT INTO users_in_groups (user_id, group_id) VALUES ((SELECT user_id FROM users WHERE email = 'user@apolo.br'), (SELECT user_group_id FROM user_group WHERE name = 'Users - Management'));
INSERT INTO users_in_groups (user_id, group_id) VALUES ((SELECT user_id FROM users WHERE email = 'user@apolo.br'), (SELECT user_group_id FROM user_group WHERE name = 'Permissions - Management'));

INSERT INTO users (name, email, password, status, created_by, creation_dt) VALUES ('User', 'restr@apolo.br', '21232f297a57a5a743894a0e4a801fc3', 'active', 1, NOW());
INSERT INTO users_in_groups (user_id, group_id) VALUES ((SELECT user_id FROM users WHERE email = 'restr@apolo.br'), (SELECT user_group_id FROM user_group WHERE name = 'Users'));
