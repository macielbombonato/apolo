...
import br.apolo.data.repository.factory.ApoloRepositoryFactoryBean;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = { "br.apolo.data.repository" },
        entityManagerFactoryRef = "entityManagerFactory",
        transactionManagerRef = "transactionManager",
        repositoryFactoryBeanClass = ApoloRepositoryFactoryBean.class)
