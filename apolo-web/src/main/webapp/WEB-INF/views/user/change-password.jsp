			...
			<div id="main-container">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form id="userForm" action="<s:url value="/${currentUser.tenant.url}/user/change-password-save"></s:url>" method="post" role="form">
							...
							<div class="form-actions">
								...
								<a href='<s:url value="/${currentUser.tenant.url}/user"></s:url>' class="btn btn-default">
