					...
					<div class="panel-body">
						...
						<form id="systemForm" action="<s:url value="/install/save"></s:url>" role="form" method="post" enctype="multipart/form-data" target="_self">
							...
							<div class="form-group">
								...
								<p>
									[${admemail}] <s:message code="install.msg.dont.use.this.email" htmlEscape="false"/>
								</p>
							</div>
							...
							<div class="form-group">
								...
								<input type="text" id="user.mobile" name="user.mobile" class="form-control" value="${install.user.mobile}" placeholder="ex: 5511998991234"/>
							</div>
