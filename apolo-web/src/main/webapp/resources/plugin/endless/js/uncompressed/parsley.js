...
!function ($) {
  ...
  */
  ...
  ParsleyField.prototype = {
    ...
    */
    , init: function ( element, type ) {
      ...
      if ( 'undefined' === typeof this.isRadioOrCheckbox ) {
        ...
        this.hapolo = this.generateHapolo();
    ...
    */
    ...
    /**
    * Hapolo management. Used for ul error
    *
    * @method generateHapolo
    * @returns {String} 5 letters unique hapolo
    */
    , generateHapolo: function () {
      return 'parsley-' + ( Math.random() + '' ).substring( 2 );
    }

    /**
    * Public getHapolo accessor
    *
    * @method getHapolo
    * @returns {String} hapolo
    */
    , getHapolo: function () {
      return this.hapolo;
    }
    ...
    */
    , ulErrorManagement: function () {
      this.ulError = '#' + this.hapolo;
      this.ulTemplate = $( this.options.errors.errorsWrapper ).attr( 'id', this.hapolo ).addClass( 'parsley-error-list' );
    }
  ...
  */
  ...
  ParsleyFieldMultiple.prototype = {
    ...
    *
    * @method getName
    * @returns {String} radio / checkbox hapolo is cleaned 'name' or data-group property
    */
   , getName: function () {
     if ( this.group ) {
  ...
  ParsleyForm.prototype = {
    ...
    */
    , removeItem: function ( elem ) {
      ...
      // identify & remove item if same Parsley hapolo
      for ( var i = 0; i < this.items.length; i++ ) {
        if ( this.items[ i ].hapolo === parsleyItem.hapolo ) {
