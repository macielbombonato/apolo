...
public enum EnviromentVariables {
	...
	DATASOURCE_URL("APOLO_DATASOURCE_URL"),
	...
	DEFAULT_emailUsername("APOLO_DEFAULT_emailUsername"),
	...
	FACEBOOK_APP_ID("APOLO_FACEBOOK_APP_ID"),
	FACEBOOK_APP_SECRET("APOLO_FACEBOOK_APP_SECRET"),
